...
export type Update_PassesMutationVariables = Exact<{
  pkColumns: Passes_Pk_Columns_Input;
  set?: InputMaybe<Passes_Set_Input>;
}>;


export type Update_PassesMutation = { __typename?: 'mutation_root', update_passes_by_pk?: { __typename?: 'passes', id: number } | null };
...
export const Update_PassesDocument = gql`
    mutation update_passes($pkColumns: passes_pk_columns_input!, $set: passes_set_input) {
  update_passes_by_pk(pk_columns: $pkColumns, _set: $set) {
    id
  }
}
    `;
export type Update_PassesMutationFn = Apollo.MutationFunction<Update_PassesMutation, Update_PassesMutationVariables>;

/**
 * __useUpdate_PassesMutation__
 *
 * To run a mutation, you first call `useUpdate_PassesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdate_PassesMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updatePassesMutation, { data, loading, error }] = useUpdate_PassesMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdate_PassesMutation(baseOptions?: Apollo.MutationHookOptions<Update_PassesMutation, Update_PassesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<Update_PassesMutation, Update_PassesMutationVariables>(Update_PassesDocument, options);
      }
export type Update_PassesMutationHookResult = ReturnType<typeof useUpdate_PassesMutation>;
export type Update_PassesMutationResult = Apollo.MutationResult<Update_PassesMutation>;
export type Update_PassesMutationOptions = Apollo.BaseMutationOptions<Update_PassesMutation, Update_PassesMutationVariables>;